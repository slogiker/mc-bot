...
| `/stop`          | `stop`        | Graceful stop via RCON. Waits 5s, kills tmux if needed. Cooldown: 30s.                       |
...
| Command                  | Permission    | Description                                                                                          |
| ------------------------ | ------------- | ---------------------------------------------------------------------------------------------------- |
| `/status`                | `status`      | Online/Offline + player list embed (v3 formatted names).                                             |
